...
export class ExtensionIntegrationService {
  ...
  async createExtensionReferralFreelancer(
  ...
  async updateExtensionReferralFreelancerStatus(
    freelancerId: string,
    isActive: boolean,
  ): Promise<ExtensionReferralSourceGroup> {
    const freelancer = await this.freelancersService.updateStatus(freelancerId, isActive);
    return this.buildFreelancerReferralSourceGroup(freelancer);
  }

  async updateExtensionReferralInternalStatus(
    internalId: string,
    isActive: boolean,
  ): Promise<ExtensionReferralSourceGroup> {
    const internal = await this.internalsService.updateStatus(internalId, isActive);
    return this.buildInternalReferralSourceGroup(internal);
  }
