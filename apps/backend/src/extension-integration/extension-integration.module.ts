...
@Module({
  ...
  controllers: [ExtensionIntegrationController, ExtensionFacebookController, ExtensionVcsPortalController],
  providers: [
  ...
  exports: [ExtensionIntegrationService, ExtensionIdempotencyService, VcsPortalJdSyncService],
})
