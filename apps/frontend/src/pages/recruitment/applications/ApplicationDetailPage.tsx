      ...
      <div className="grid gap-4 md:grid-cols-2">
        <Card>
          ...
          <CardContent className="grid gap-3 sm:grid-cols-2">
            ...
            />
                        <DetailField label="Updated" value={formatRecruitmentDateTime(mapping?.createdAt)} />
          </CardContent>
        </Card>
        ...
        <Card>
          ...
          <CardContent className="grid gap-3 sm:grid-cols-2">
            ...
            />
                        <DetailField label="Updated" value={formatRecruitmentDateTime(aiScreening?.createdAt)} />
          </CardContent>
        </Card>
      </div>
